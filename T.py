...
class Model:
    ...
    def build_model(self, input):
        ...
        self.pool4 = self.s_max_pool(self.conv4_3, 'pool4')
        ...
        self.pool5 = self.s_max_pool(self.conv5_3, 'pool5')
        ...
        tconv3_4 = tf.nn.relu(self._dilated_conv2d(self.conv3_3, 3, 128, 1, 0.01, 'tconv3_4', biased = True))
