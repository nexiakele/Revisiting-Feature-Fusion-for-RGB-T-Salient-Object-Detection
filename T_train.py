...
class Model:
    ...
    def build_model(self):
        ...
        #self.conv5_1 = self._conv_layer(self.conv4_3, 1, "conv5_1")
        ...
        self.conv5_3_t = tf.nn.relu(self.Conv_2d(vgg_t.pool5, [3, 3, 512, 256],  0.01, padding='SAME', name='conv5_3_t'))
        ...
        conv6_2 = tf.nn.relu(self._dilated_conv2d(self.conv5_3_t, 3, 128, 2, 0.01, 'conv6_2', biased = True))
        ...
        conv6_3_ = tf.nn.relu(self.Conv_2d(tf.concat([self.conv5_3_t, conv6_3], axis=3), [1, 1, 384, 256],  0.01, padding='SAME', name='conv6_3_'))
        ...
        self.conv6_6 = tf.nn.relu(self.Conv_2d(tf.concat([self.conv5_3_t, conv6_2, conv6_3, conv6_4, conv6_5], axis=3),
        ...
        self.label3 = self.upsampling_2d(label, name='label3', size = (0.125, 0.125))
        ...
        decoder1 = conv6_up + self.tconv3_6_*self.global_attention_layer(self.conv6_6, 'conv3')
        ...
        decoder2 = decoder_up + self.tconv2_5_*self.global_attention_layer(self.conv6_6, 'conv2') + conv6_up2 #tf.nn.relu()
        ...
        self.score_t = self.Conv_2d(decoder2_, 
        ...
        self.Score = self.upsampling_2d(self.score_t, name='Score', size = (2, 2)) #, size = (2, 2)
