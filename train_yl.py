...
if __name__ == "__main__":
    ...
    train_list_r=os.listdir('/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/TRGB-img2-train')#[]/home/ly/disk2/xiao/RGBT2/DATA/RGB
   ...
   # np.random.shuffle(indexs)
    ...
    n_epochs = 20
    img_size = RT.img_size
    label_size = RT.label_size
    if not os.path.exists('Model_yl'):
        os.mkdir('Model_yl')
    
    ckpt = tf.train.get_checkpoint_state('Model_yl/')   
    ...
    for i in range(n_epochs):
        ...
        for f_img_r in train_list_r:
            ...
            f_img_r = os.path.join('/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/TRGB-img2-train', f_img_r)#/home/ly/disk2/xiao/RGBT2/DATA/RGB
            ...
            #thermal = cv2.imread(os.path.join('thermal', name + '.png'))
            f_img_t = os.path.join('/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/TIR-img2-train', name + '.jpg')#/home/ly/disk2/xiao/RGBT2/DATA/thermal
            img_t = cv2.imread(f_img_t)
            ...
            f_label = os.path.join('/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/TGT2_2-train', name + '.png')#/home/ly/disk2/xiao/RGBT2/DATA/GT
            label = cv2.imread(f_label)
        ...
        saver.save(sess, 'Model_yl/model.ckpt', global_step=i+15)
