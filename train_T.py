...
def load_train_list():
    ...
    with open('/home/ly/disk2/xiao/RGBT/datas/train_t.txt') as f:
...
if __name__ == "__main__":
    ...
    for i in range(n_epochs):
        ...
        for f_img_r in train_list_r:
            ...
            f_label = os.path.join('datas/gthermal', name + '.png')
            #print(f_label)
            ...
            _, loss , acc= sess.run([train_op, Loss, model.accuracy],
                                      feed_dict={model.input_holder_t: img_r, model.label_holder: label})
