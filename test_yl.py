...
if __name__ == "__main__":
    ...
    saver.restore(sess, 'Model_yl/model.ckpt-21')
    ...
    ###m = 0
    imgs_r = os.listdir('/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/RGB-img1-test')
    #imgs_t = os.listdir('thermal-test')
    for f_img_r in imgs_r:
            #print(f_img_r)
            #print(f_img_t)

            path = os.path.join('/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/RGB-img1-test', f_img_r)
            ...
            f_img_t = os.path.join('/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/IR-img1-test', img_name + '.png')
