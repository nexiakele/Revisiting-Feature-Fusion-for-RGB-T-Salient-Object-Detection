...
if __name__ == "__main__":
    ...
    train_list_r=os.listdir('/home/ly/disk2/xiao/RGBT1/DATA/RGB')#[]
   ...
   # np.random.shuffle(indexs)
    ...
    ckpt = tf.train.get_checkpoint_state('Model_loss/')   
    ...
    for i in range(n_epochs):
        ...
        for f_img_r in train_list_r:
            ...
            f_img_r = os.path.join('/home/ly/disk2/xiao/RGBT1/DATA/RGB', f_img_r)
            ...
            #thermal = cv2.imread(os.path.join('thermal', name + '.png'))
            f_img_t = os.path.join('/home/ly/disk2/xiao/RGBT1/DATA/thermal', name + '.png')
            ...
            f_label = os.path.join('/home/ly/disk2/xiao/RGBT1/DATA/GT', name + '.png')
        ...
        saver.save(sess, 'Model_loss/model.ckpt', global_step=i)
