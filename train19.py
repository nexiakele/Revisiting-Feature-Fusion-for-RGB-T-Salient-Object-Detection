...
if __name__ == "__main__":
   ...
   # np.random.shuffle(indexs)
    ...
    n_epochs = 30
    img_size = RT19.img_size
    label_size = RT19.label_size
    if not os.path.exists('Model19'):
        os.mkdir('Model19')
    
    ckpt = tf.train.get_checkpoint_state('Model19/')   
    ...
    for i in range(n_epochs):
        ...
        saver.save(sess, 'Model19/model.ckpt', global_step=i)
