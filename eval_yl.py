...
def PR_Curve(resDir, gtDir):
    ...
    #elif method=='MFCF':
       #plt.plot(recall, prec, label = "MFCF", linewidth = 1)
    #elif method=='DSS': 
   ...
   # elif method=='TSAA':
    ...
    ##plt.grid(linestyle='--')
    #plt.show()
    #save_name = os.path.join('/home/ly/disk2/xiao/RGBT1', 'RGBT10'+'_pr.png')
...
if __name__ == "__main__":
    ...
    methods =['1']
    #methods =['UCF','Amulet','DSS','BMPM', 'CPD','TSAA', 'PDNet', 'MRCMC', 'CGL', 'MFSR', 'MFCF', 'Ours']
   # methods =['MRCMC','UCF','Amulet','NLDF','DSS','BMPM', 'CGL', 'CPD', 'MFSR', 'TSAA', 'PDNet','Ours']
    #label = ('UCF','Amulet','DSS','BMPM', 'CPD','TSAA', 'PDNet', 'MRCMC', 'CGL', 'MFSR', 'MFCF', 'Ours')
    #methods = ['sMFCF']
    mean_prec = []
    mean_recall= []
    mean_fmea = []
    ...
    for method in methods:
      ...
      gtDir = '/home/ly/disk1/LGH/Datasets/Salient_Object_Detection/RGBT/train4/GT1-test'#DATA/GT-test154' #
   ...
   # plt.show()
    #save_name = os.path.join('/home/ly/disk2/xiao/RGBT1', 'RGBT10'+'_bar.png')
   # plt.savefig(save_name)
